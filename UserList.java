        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener(){
            ...
            public void onTabChanged(String tabId) {
                ...
                if(tabId.equals("Latest")) {
                    ...
                    //Change first image
                    CustomList adapter = new CustomList(UserList.this, things, images);
                    ...
                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view,
                            ...
                            Intent newact=new Intent(UserList.this,complaintshow.class);
                ...
                if(tabId.equals("Popular")) {
                    ...
                    CustomList adapter = new
                            CustomList(UserList.this,things1, images1);
